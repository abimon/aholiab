...
<div class="row">
    <div class="col-md-5 p-3">
        <img src="{{asset('storage/users/avatars/'.(Auth()->user()->avatar))}}" style="height:60vh;width:100%;object-fit:cover" alt="">
                    ...
                    <form action="{{route('user.update',Auth()->user()->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="m-3 card p-3 border-dark bg-transparent" style="border-style:dashed;">
                                <img id="out" src="{{asset('storage/users/avatars/'.Auth()->user()->avatar)}}" style="width: 100%; object-fit:contain;" />
    ...
    <div class="col-md-6">
        <form action="{{route('user.update',Auth()->user()->id)}}" method="post">
            ...
            <div class="row mb-2">
                <label for="" class="col-4">Facebook URL</label>
                <input type="url" class="col-8 form-control" name="facebook" value="{{Auth()->user()->facebook}}">
            </div>
            
            <div class="row mb-2">
                <label for="" class="col-4">Linkedin URL</label>
                <input type="url" class="col-8 form-control" name="linkedin" value="{{Auth()->user()->linkedin}}">
            </div>
            
            <div class="row mb-2">
                <label for="" class="col-4">Instagram URL</label>
                <input type="url" class="col-8 form-control" name="instagram" value="{{Auth()->user()->instagram}}">
            </div>
            <div class="text-center">
